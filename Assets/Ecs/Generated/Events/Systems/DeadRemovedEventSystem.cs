...
public sealed class DeadRemovedEventSystem : JCMG.EntitasRedux.ReactiveSystem<GameEntity>
{
	...
	public DeadRemovedEventSystem(IContext<GameEntity> context) : base(context)
	{
	}

	protected override JCMG.EntitasRedux.ICollector<GameEntity> GetTrigger(JCMG.EntitasRedux.IContext<GameEntity> context)
	{
		return new SlimCollector<GameEntity>(context, GameComponentsLookup.Dead, EventType.Removed);
	}
	...
	protected override void Execute(System.Collections.Generic.IEnumerable<GameEntity> entities)
	{
		foreach (var e in entities)
		{
			...
			e.DeadRemovedListener.Invoke(e);
		}
	}
}
