...
public sealed class ScaleEventSystem : JCMG.EntitasRedux.ReactiveSystem<GameEntity>
{

	public ScaleEventSystem(IContext<GameEntity> context) : base(context)
	{
	}

	protected override JCMG.EntitasRedux.ICollector<GameEntity> GetTrigger(JCMG.EntitasRedux.IContext<GameEntity> context)
	{
		return new SlimCollector<GameEntity>(context, GameComponentsLookup.Scale, EventType.Added);
	}
	...
	protected override void Execute(System.Collections.Generic.IEnumerable<GameEntity> entities)
	{
		foreach (var e in entities)
		{
			...
			e.ScaleListener.Invoke(e, component.Value);
		}
	}
}
