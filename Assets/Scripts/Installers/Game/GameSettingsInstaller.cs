...
namespace Installers.Game
{
    ...
    public class GameSettingsInstaller : ScriptableObjectInstaller
    {
        ...
        [SerializeField] private ResourcesParametersBase _resourcesParametersBase;
         [SerializeField] private UnitPrefabsCollection _unitPrefabsCollection;
         [SerializeField] private UnitParametersBase _unitParametersBase;
        ...
        public override void InstallBindings()
        {
            ...
            Container.Bind<IUnitParameters>().FromSubstitute(_unitParametersBase).AsSingle();
        }
    }
}